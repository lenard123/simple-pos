...
--
-- Host: localhost
-- Generation Time: Mar 10, 2022 at 08:37 AM
...
--
ALTER TABLE `products`
  ADD CONSTRAINT `products_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT;
COMMIT;
